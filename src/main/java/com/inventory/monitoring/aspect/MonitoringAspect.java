package com.inventory.monitoring.aspect;
...
public class MonitoringAspect {
    ...
    public Object monitorControllerMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String metricName = "inventory.controller.duration";
        ...
        try {
            ...
            Counter.builder("inventory.controller.errors")
    ...
    public Object monitorServiceMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            meterRegistry.timer("inventory.service.duration",
                    "service", "inventory",
                    "class",  className,
                    "method", methodName)
