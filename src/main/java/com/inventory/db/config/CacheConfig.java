package com.inventory.db.config;
 ...
 *
 * Usage in service:
 *   @Cacheable(value = "inventoryCache", key = "#id")
 *   @CacheEvict(value = "inventoryCache", key = "#id")
 *   @CachePut(value  = "inventoryCache", key = "#result.id")
 */
@Configuration
@EnableCaching
public class CacheConfig {
    ...
    public CacheManager cacheManager(RedisConnectionFactory factory) {
        ...
        caches.put("inventoryCache",       defaultConfig().entryTtl(MEDIUM));
        caches.put("inventoryListCache",   defaultConfig().entryTtl(SHORT));
        caches.put("inventoryCountCache",  defaultConfig().entryTtl(SHORT));
        caches.put("inventoryRefCache",    defaultConfig().entryTtl(LONG));
